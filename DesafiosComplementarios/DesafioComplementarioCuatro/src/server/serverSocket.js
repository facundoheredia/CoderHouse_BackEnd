        ...
        socket.on("eliminarProductoDeCarrito", async eliminarProductoDeCarrito => {
            ...
            if(carritoExistente) {
                ...
                if(productoExistente) {
                    ...
                    //const indiceProducto = carritoExistente.productos.findIndex(producto => producto.idProducto === idProductoEliminarProductoEnCarrito);
                    //carritoExistente.productos.splice(indiceProducto,0);
                    //await carritoModel.findByIdAndUpdate(idCarritoEliminarProductoEnCarrito, carritoExistente);
                } else {
                    console.log("El producto no existe");
                }
            } else {
